...
public class CommentRepository (DataContext context) : ICommentRepository
{
    ...
    {
        return await context.Comments.FirstOrDefaultAsync(c => c != null && c.Id == id);
    }
    ...
    {
        return await context.Comments.Where(c => c != null && c.PatternCommentId == parentId).ToListAsync();
    }
